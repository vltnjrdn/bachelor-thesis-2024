...
daten_Pexp_R <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/Pexp_Parameter_Recovery.xlsx")
daten_Mconf_R <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/Mconf_Parameter_Recovery.xlsx")
daten_mu_m_R <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/mu_m_Parameter_Recovery.xlsx")
daten_rho_R <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/rho_Parameter_Recovery.xlsx")

daten_Pexp_M <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/Pexp_Parameter_Correlation_M.xlsx")
daten_Mconf_M <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/Mconf_Parameter_Correlation_M.xlsx")
daten_mu_m_M <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/mu_m_Parameter_Correlation_M.xlsx")
daten_rho_M <- read_excel("C:/Users/Valentina/OneDrive - Universitaet Bern/Bachelor/ParamRec/rho_Parameter_Correlation_M.xlsx")
