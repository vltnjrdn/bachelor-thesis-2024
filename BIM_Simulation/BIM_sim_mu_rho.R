...
# Requires the function BIM_simulation to be loaded into the global environment

## INPUTS
# * ntrial
#
# number of trials per simulated data set, default is 50'000
#
# * parameter values
#
# Pexp and Mconf are set to 0.4.
# Mu_m takes on the values (-1, -0.5, 0, 0,5, 1).
# Rho takes on the values (-0.8, -0.4, 0, 0.4, 0.8).

## OUTPUTS
# * Folder containing 25 pngs of single plots for each parameter combination and a gtable with all 25 plots.
